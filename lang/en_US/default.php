...
// Found in: resources\views\user\chat.blade.php
		...
		'Copy Billing Info to Shipping' => 'Copy Billing Info to Shipping',
		...
		'shipping_info_message' => 'Your order will be processed and shipped within 2-3 business days.',
		'estimated_delivery_message' => 'Estimated delivery time is 3-5 business days after shipping.',
		...
		'Items' => 'Items',
		'Item' => 'Item',
		'ZIP code must contain only numbers' => 'ZIP code must contain only numbers',
		'Card number must be 15 or 16 digits' => 'Card number must be 15 or 16 digits',
		'CVV must be 3 digits' => 'CVV must be 3 digits',
		'Invalid expiry date or card has expired' => 'Invalid expiry date or card has expired',
