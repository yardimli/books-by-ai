				...
				<div class="table-responsive">
					<table class="table">
						...
						<tr>
							...
							<td class="text-end">{{__('default.checkout.currency_prefix')}}{{ number_format($order->subtotal, 2) }}{{__('default.checkout.currency_suffix')}}</td>
						</tr>
						<tr>
						...
						<tr>
							...
							<td class="text-end"><strong>{{__('default.checkout.currency_prefix')}}{{ number_format($order->total, 2) }}{{__('default.checkout.currency_suffix')}}</strong></td>
						</tr>
						</tfoot>
					</table>
				</div>
