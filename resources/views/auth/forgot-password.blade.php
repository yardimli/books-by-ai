...
<html lang="en">
<head>
	<title>{{__('default.Books By AI')}} - {{__('default.Boilerplate Site Tagline')}}</title>

	<!-- Meta Tags -->
	<meta charset="utf-8">
	<meta name="viewport" content="width=device-width, initial-scale=1, shrink-to-fit=no">
	<meta name="author" content="my-laravel-saas-site.com">
	<meta name="description" content="{{__('default.Books By AI')}} - {{__('default.Boilerplate Site Tagline')}}">
        ...
        <div class="card card-body p-4 p-sm-5 mt-sm-n5 mb-n5">
          ...
          <h2 class="h1 mb-2 mt-4">Forgot password?</h2>
           ...
           <form class="mt-3">
             ...
             <!-- Copyright -->
             <p class="mb-0 mt-3">©2024 <a target="_blank" href="https://www.my-laravel-saas-site.com/">{{__('default.Books By AI')}}.</a> All rights reserved</p>
           </form>
          <!-- Form END -->
        </div>
        <!-- Sign in form START -->
