	...
	<div class="tab-pane" id="nav-setting-tab-6">
		...
		<div class="card">
			...
			<div class="card-header border-0 pb-0">
				...
				<p
					class="mb-2">{{__('default.We are sad to see you go, but we hope that Books By AI has been an enjoyable experience for you. We wish you the best in your future endeavors. Goodbye!')}}</p>
			</div>
			<!-- Card header START -->
			<!-- Card body START -->
			<div class="card-body">
