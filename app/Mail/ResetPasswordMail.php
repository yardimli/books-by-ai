<?php
	...
	class ResetPasswordMail extends Mailable
	{
		...
		public function build()
		{
			...
			if ($locale == 'en_US') {
				$subject = '【Books By AI】- Password Reset Request';
				$email_view = 'emails.reset_password';
			}
			if ($locale == 'tr_TR') {
				$subject = '【Books By AI】- Şifre Sıfırlama İsteği';
				$email_view = 'emails.reset_password_tr';
			}

			return $this->from(env('MAIL_FROM_ADDRESS','support@my-laravel-saas-site.com'), env('MAIL_FROM_NAME', 'Books By AI Support'))
				->subject($subject)
				->view($email_view)
